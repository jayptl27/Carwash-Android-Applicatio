...
public class Hatchback extends AppCompatActivity {
   ...
   private TextView totalprice, textView12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView12 = findViewById(R.id.textView12); //vehicle type
...
//                    hatch.setType1(c1);
//                    databaseReference.child(String.valueOf(i + 1)).setValue(hatch);
                    counter++;
                    body_wash_price = 750;
                }
...
//                    databaseReference.child(String.valueOf(i + 1)).setValue(hatch);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (counter>0) {
                    ...
                    hatch.setPrice(totalprice.getText().toString());
                    hatch.setVehicletype(textView12.getText().toString());
                    databaseReference.child(String.valueOf(i + 1)).setValue(hatch);

                    startActivity(new Intent(getApplicationContext(), TimeAndDate.class));
                } else{
                    Toast.makeText(Hatchback.this, "Select Atleast 1 Wash Type.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.Logout:
                Toast.makeText(Hatchback.this, "You are Logged Out", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Hatchback.this, MainActivity.class));
                return true;

            case R.id.Location:
                startActivity(new Intent(Hatchback.this, Location.class));
                return true;

            case R.id.Detail:
                startActivity(new Intent(Hatchback.this, Details.class));
                return true;

            case R.id.Payment:
                startActivity(new Intent(Hatchback.this, PaymentMain.class));
                return true;
