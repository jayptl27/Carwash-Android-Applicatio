...
public class Sallon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sallon);
        ...
        sallon = findViewById(R.id.sallon);

        sallonCar = new SallonCar();
        ...
        total.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checkBox4.isChecked()==true){
                    extreme_interior_cleaning_price = 1000;
                    counter++;
                }
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checkBox.isChecked()){
                    sallonCar.setType1(c1);
                    databaseReference.child(String.valueOf(i + 1)).setValue(sallonCar);
                }


                //checkbox 2
                if(checkBox2.isChecked()){
                    sallonCar.setType2(c2);
                    databaseReference.child(String.valueOf(i + 1)).setValue(sallonCar);
                }
                ...
                if(checkBox5.isChecked()){
                    sallonCar.setType5(c5);
                    databaseReference.child(String.valueOf(i + 1)).setValue(sallonCar);
                }

                sallonCar.setPrice(totalprice.getText().toString());
                sallonCar.setVehicletype(sallon.getText().toString());
                databaseReference.child(String.valueOf(i + 1 )).setValue(sallonCar);

                startActivity(new Intent(getApplicationContext(), TimeAndDate.class));
            } else{
                    Toast.makeText(Sallon.this, "Select Atleast 1 Wash Type.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.Logout:
                Toast.makeText(Sallon.this, "You are Logged Out", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Sallon.this, MainActivity.class));
                return true;

            case R.id.Location:
                startActivity(new Intent(Sallon.this, Location.class));
                return true;

            case R.id.Detail:
                startActivity(new Intent(Sallon.this, Details.class));
                return true;

            case R.id.Payment:
                startActivity(new Intent(Sallon.this, PaymentMain.class));
                return true;
