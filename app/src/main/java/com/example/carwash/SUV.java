...
public class SUV extends AppCompatActivity {
    ...
    private TextView totalprice, SUV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_u_v);
        ...
        total.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checkBox4.isChecked()==true){
                    extreme_interior_cleaning_price = 1250;
                    counter++;
                }
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checkBox.isChecked()){
                    suvtype.setType1(c1);
                    databaseReference.child(String.valueOf(i + 1)).setValue(suvtype);
                }
                ...
                suvtype.setPrice(totalprice.getText().toString());
                suvtype.setVehicletype(SUV.getText().toString());
                databaseReference.child(String.valueOf(i + 1 )).setValue(suvtype);


                startActivity(new Intent(getApplicationContext(), TimeAndDate.class));
            } else{
                    Toast.makeText(SUV.this, "Select Atleast 1 Wash Type.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.Logout:
                Toast.makeText(SUV.this, "You are Logged Out", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(SUV.this, MainActivity.class));
                return true;

            case R.id.Location:
                startActivity(new Intent(SUV.this, Location.class));
                return true;
            case R.id.Detail:
                startActivity(new Intent(SUV.this, Details.class));
                return true;

            case R.id.Payment:
                startActivity(new Intent(SUV.this, PaymentMain.class));
                return true;
